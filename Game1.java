...
class Cell1 {
 ...
 public WorldImage cellImage(int waterHeight) {
     ...
     return this.makeScene().placeImageXY(new RectangleImage(10, 10, 
                     OutlineMode.SOLID, c), this.x * 10 + 5, 
                     this.y * 10 + 5);
 }
...
class Player {
  ...
  public WorldImage playerImage() {
      return this.makeScene().placeImageXY(new FromFileImage("guy.png"),
                     this.x * 10 + 5, this.y * 10 + 5);
  }
...
class Target {
  ...
  public WorldImage image() {
      return this.makeScene().placeImageXY(new FromFileImage("cog.png"),
                      this.x * 10 + 5, this.y * 10 + 5);
  }
...
class HelicopterTarget extends Target {
    ...
    public WorldImage image() {
        return this.makeScene().placeImageXY(new FromFileImage("helicopter.png"),
                        this.x * 10 + 5, this.y * 10 + 5);
    }
...
class ForbiddenIslandWorld extends World {
    ...
    public WorldImage score() {
        return this.makeScene().placeImageXY(new TextImage("Score: ".concat(
                Integer.toString(this.score)), 
                        15, FontStyle.BOLD_ITALIC, Color.BLACK), 100, 50);
    }
